...
const columns = [
  ...
  { title:"Actions", dataIndex:"actions", key:"DoctorApproval", render:(text, record)=>(
...
console.log(doctors)
  return (
    <Layout>
      ...
      <div >
      <Table className="text-center m-3" columns={columns} dataSource={doctors}  key={record=>doctors._id}  />
      </div>
    </Layout>
  );
}
